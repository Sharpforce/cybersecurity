...
Lorsque la victime, authentifiée sur le serveur vulnérable \(à l'adresse 192.168.56.184\), naviguera sur la page, la requête XHR sera exécutée par son navigateur. L'attaquant sera en mesure de récupérer tout le contenu de la page \(à la place de l'afficher simplement dans la console\) :
