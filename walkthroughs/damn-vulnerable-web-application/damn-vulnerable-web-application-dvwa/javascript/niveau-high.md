...
L'analyse du code Javascript nous donnera sans doute plus d'information :
...
J'ai tenté d'analyser ce fichier mais le Javascript n'est pas du tout mon fort. Dans le tableau contenant des chaines de caractères nous pouvons voir l'occurrence "SHA256" ce qui laisse penser que les jetons, possédant 64 caractères sont de telles empreintes.
...
Pour avoir la valeur du jeton associé à la phrase "success" il nous faut rassembler tous les morceaux. Le jeton correspond en fait au résultat de l'opération :
